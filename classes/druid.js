...
class Druid extends CharacterClass {
  constructor() {
    super(
      ...
      [
        { name: 'Charm Immunity', minLevel: 1 },
        { name: 'Divine Magic', minLevel: 1 },
        { name: 'Energy Resistance', minLevel: 1 },
        { name: 'Identification', minLevel: 1 },
        { name: 'Languages', minLevel: 3 },
        { name: 'Pass Without Trace', minLevel: 3 },
        { name: 'Path-finding', minLevel: 3 },
        { name: 'Shape Change', minLevel: 7 },
        { name: 'Stronghold', minLevel: 12 },
      ],
    );
    this.className = 'Druid';
    this.spellsKnown = {
      1: [{ spellLevel: 1, known: 1 }],
      2: [
      ...
      14: [
        { spellLevel: 1, known: 6 },
        { spellLevel: 2, known: 6 },
        { spellLevel: 3, known: 6 },
        { spellLevel: 4, known: 5 },
        { spellLevel: 5, known: 5 },
      ],
    };
  }
